...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dense-pruning-method", type=str, default="sigmoied_threshold:1d_alt"
    )
    ...
    parser.add_argument(
        "--attention-pruning-method", type=str, default="sigmoied_threshold"
    )
    ...
    def set_key(param_dict, key, val):
    ...
    set_key(param_dict, "regularization_final_lambda", args.regularization_final_lambda)
    set_key(param_dict, "dense_pruning_method", args.dense_pruning_method)
    set_key(param_dict, "dense_block_rows", args.dense_block_rows)
    set_key(param_dict, "dense_block_cols", args.dense_block_cols)
    set_key(param_dict, "dense_lambda", args.dense_lambda)
    set_key(param_dict, "attention_pruning_method", args.attention_pruning_method)
    set_key(param_dict, "attention_block_rows", args.attention_block_rows)
    set_key(param_dict, "attention_block_cols", args.attention_block_cols)
    set_key(param_dict, "attention_lambda", args.attention_lambda)
    set_key(param_dict, "attention_output_with_dense", args.attention_output_with_dense)
